#!/bin/sh
#PBS -N permeability-c_grad_p=0.1
#PBS -l nodes=1:ppn=3
...
cmake . && make
cd python
python permeability-starter.py 0 1.0 0.1 1.0e3 2.0e3 &
python permeability-starter.py 1 1.0 0.1 4.0e3 1.0e4 &
python permeability-starter.py 2 1.0 0.1 2.0e4 4.0e4 &
wait
