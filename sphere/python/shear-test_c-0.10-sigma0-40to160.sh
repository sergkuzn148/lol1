#!/bin/sh
#PBS -N shear-test-c_0.10-sigma0-40to160
#PBS -l nodes=1:ppn=3
...
cmake . && make
cd python
python shear-starter.py 0 1.0 0.10 40000.0 &
python shear-starter.py 1 1.0 0.10 80000.0 &
python shear-starter.py 2 1.0 0.10 160000.0 &
wait
