...
cmake . && make
cd python
python continue_sim.py shear-sigma0=10000.0-c_phi=1.0-c_grad_p=1.0 1 0 &
python continue_sim.py shear-sigma0=20000.0-c_phi=1.0-c_grad_p=1.0 1 1 &
python continue_sim.py shear-sigma0=40000.0-c_phi=1.0-c_grad_p=1.0 1 2 &
wait
