...
cmake . && make
cd python
python permeability-starter.py 0 0.1 1.0 1.0e3 2.0e3 &
python permeability-starter.py 1 0.1 1.0 4.0e3 1.0e4 &
python permeability-starter.py 2 0.1 1.0 2.0e4 4.0e4 &
wait
