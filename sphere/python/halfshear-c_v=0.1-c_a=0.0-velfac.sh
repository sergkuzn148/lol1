#!/bin/sh
#PBS -N halfshear-c_v=0.1-c_a=0.0-velfac
#PBS -l nodes=1:ppn=3
...
python halfshear-starter-rate.py 0 1 1.0 0.1 20000.0 2.0 0.0 &
python halfshear-starter-rate.py 1 1 1.0 0.1 20000.0 1.0 0.0 &
python halfshear-starter-rate.py 2 1 1.0 0.1 20000.0 0.5 0.0 &
wait
