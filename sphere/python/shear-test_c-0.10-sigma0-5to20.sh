#!/bin/sh
#PBS -N shear-test-c_0.10-sigma0-5to20
#PBS -l nodes=1:ppn=3
...
cmake . && make
cd python
python shear-starter.py 0 1.0 0.10 5000.0 &
python shear-starter.py 1 1.0 0.10 10000.0 &
python shear-starter.py 2 1.0 0.10 20000.0 &
wait
