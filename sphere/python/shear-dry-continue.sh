...
cmake . && make
cd python
python continue_sim.py cons-sigma0=10000.0-c_phi=1.0-c_grad_p=1.0 0 0 &
python continue_sim.py cons-sigma0=10000.0-c_phi=1.0-c_grad_p=0.1-tall 0 1 &
python continue_sim.py cons-sigma0=10000.0-c_phi=1.0-c_grad_p=0.01-tall 0 2 &
wait
