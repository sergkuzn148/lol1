...
cmake . && make
cd python
python continue_sim.py halfshear-sigma0=20000.0-ss=10000.0-shear 0 0 &
python continue_sim.py halfshear-sigma0=20000.0-ss=12500.0-shear 1 0 &
python continue_sim.py halfshear-sigma0=20000.0-ss=15000.0-shear 2 0 &
wait
